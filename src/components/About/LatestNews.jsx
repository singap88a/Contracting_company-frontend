...
const LatestNews = () => {
  ...
  return (
    <section className="py-16 bg-white text-right">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="flex justify-between items-end mb-16 px-4">
           <Link to="/articles" className="py-3 px-8 border-2 border-primary-500 text-primary-500 rounded-xl font-black text-sm hover:bg-primary-500 hover:text-white transition-all">
              عرض الكل
           </Link>
           <div>
              <span className="text-primary-500 font-extrabold uppercase tracking-widest text-sm mb-4 block">أخبارنا</span>
          ...
          {news.map((item, index) => (
            ...
            >
              <Link to={`/articles/${item.id}`} className="block">
                ...
                <div className="flex items-center gap-2 text-primary-500 font-black group-hover:gap-4 transition-all justify-end">
